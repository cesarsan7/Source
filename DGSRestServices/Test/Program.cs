...
namespace Test
{
    class Program
    {
        public static void Main(string[] args)
        {
            ...
            DGSService.DGSWCFServiceClient objDGSServiceClient = new DGSService.DGSWCFServiceClient();
           ...
           //obGSServiceClient.addAgentService(objModel);

           //ookFacade BookFacade1 = new BookFacade();
           //ookFacade1.addBookFacade(objModelBook);
